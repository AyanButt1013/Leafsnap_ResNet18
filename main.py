...
# Initialize FastAPI
app = FastAPI(title="Leafsnap Leaf Classifier API")



# Load ONNX model
session = ort.InferenceSession("model/resnet18_leafsnap.onnx")
...
async def predict(file: UploadFile = File(...)):
    """
    Upload an image and return the predicted leaf class
    """
